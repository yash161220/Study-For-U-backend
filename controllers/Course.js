...
// create-course-handler (same as tag 1st create then send details)
...
// getallcourses (so it provide all the data)
...
// getall course details (in which everything in  populate terns section , subSec, category )
